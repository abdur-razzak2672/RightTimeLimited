      ...
      <div className="footer-main section-padding--bottom footer-main--top-padding ">
                ...
                {show === "1" ? (
                  ...
                  <>
                    ...
                    <ul className="footer-widget__contact">
                      <li>
                        <i className="fa fa-phone"></i>
                        <a className="mx-4" href="tel:+18187790442">
                          {" "}
                          +1510 298 6114
                        </a>
                      </li>
                      ...
                      <li>
                        <i className="fa fa-envelope"></i>
                        <a className="mx-4" href="mailto:coo.usa@righttime.biz">
                          {" "}
                  ...
                  <>
                    ...
                    <ul className="footer-widget__contact">
                      <li>
                        <i className="fa fa-phone"></i>
                        <a className="mx-4" href="tel:+61490517545">
                          {" "}
                          (+61) 490517545,
                        </a>
                      </li>
                      ...
                      <li>
                        <i className="fa fa-envelope"></i>
                        <a className="mx-4" href="mailto:coo.au@righttime.biz">
                  ...
                  <>
                    ...
                    <ul className="footer-widget__contact">
                      <li>
                        <i className="fa fa-phone"></i>
                        <a className="mx-4" href="tel:+492311377672">
                          {" "}
                          (+49) 2311377672,
                        </a>
                      </li>
                      ...
                      <li>
                        <i className="fa fa-envelope"></i>
                        <a className="mx-4" href="mailto:coo.de@righttime.biz">
                  ...
                  <li>
                    <a href="/contact-us" className="mt-3 rounded-5">
                      <span className="text-light">
                        Subscrib Now<i className="mx-3 fas fa-arrow-right"></i>
                      </span>
                    </a>{" "}
                  </li>
                  <li>
                    ...
                    <a href="/all-job" className="mt-3 rounded-5">
                      <span className="text-light text-center">
                        Job Alert !<i className="mx-3 fas fa-arrow-right"></i>
                      </span>
                    </a>{" "}
                  </li>
                </ul>
        ...
        <div className="social mt-0">
          <ul className="footer-widget__social">
            <li>
              <a
                style={{ backgroundColor: "#d9387a" }}
                target="_blank"
                href="https://www.linkedin.com/company/right-time-limited/?viewAsMember=true"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                style={{ backgroundColor: "#008def" }}
                target="_blank"
                href="https://www.facebook.com/RightTimeLimited"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                style={{ backgroundColor: "#eb733b" }}
                target="_blank"
                href="https://www.instagram.com/righttimelimited/"
                rel="noreferrer"
              >
          ...
          <div>
            <p className="text-center mt-2 ">
              <img loading="lazy" decoding="async"
                ...
                alt=""
              />
              Copyright © 2009 – {currentYear} Right Time Limited (Private
              Limited Company) All rights reserved. Terms and Conditions.
            </p>
          </div>
        </div>
      </div>
