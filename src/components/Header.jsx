          ...
          <li className="menu-item-has-children">
            ...
            <li className="menu-item-has-children">
              ...
              <ul>
                ...
                <li>
                  <Link style={{lineHeight:"1.2"}}   to="/educational-institutions">
            ...
            <li className="dropdown serviceNav2 steps-sampling">
              ...
              <div className="dropdown-content">
                <Container className="mt-4">
                  ...
                  <a   style={{fontWeight:"bold",color:"orange"}}href="/security-testing">Security Testing</a>
            ...
            <li  className="menu-item-has-children servicNav steps-sampling">
              ...
              <ul>
                <li className="menu-item-has-children">
                  ...
                  <ul>
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/information-security-Special">
                    ...
                    <li>
                      <Link to="/providing-security">
                        Providing Security
                      </Link>
                    </li>
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/consultation-on-shaping">
                ...
                <li className="menu-item-has-children">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/information-technology">
                        Information Technology Audit
                      </Link>
                    </li>
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/information-security-graded">
                        Information Security Graded Audit
                      </Link>
                    </li>
              
                    <li>
                      <Link to="/dc-drs-auditing">
                        DC & DRS Auditing
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="menu-item-has-children">
                  ...
                  <ul>
                    <li>
                      <Link  style={{lineHeight:"1.2"}}  to="/vulnerability-assessment">
                        Vulnerability Assessment & Presentation Testing Services
                      </Link>
                    </li>
                    <li>
                      <Link to="/digital-forensics">
                        Digital Forensics
                      </Link>
                    </li>
                    <li>
                ...
                <li className="menu-item-has-children">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/iso-international">
            ...
            <li className="dropdown serviceNav2 steps-sampling">
              ...
              <div  style ={{  minWidth: "600px",left:"-280px",height:"400px"}} className="dropdown-content">
                <Container className="mt-4">
                  <Row>
                    <Col style={{borderRight:"1px solid #6f42c1"}}>
                    <a  style={{fontWeight:"bold",color:"orange",lineHeight:"1.2" }}href="/siem">Security assessment (VA & PT) Tools</a>
 
                      <a className="mt-3" href="/burp-suite">Burp Suite</a>
                      <a className="mt-3"  href="/acunetix">Net Sparker</a>

                                       <a  style={{lineHeight:"1.2"}}  className="mt-3"  href="/netsparker">Tenable (multiple solutions)</a>
                  ...
                  <Col>
                  <a  style={{fontWeight:"bold",color:"orange",lineHeight:"1.2"}}href="/association-partners">Cyber Security Management & Visibility solutions</a>
                  ...
                  SIEM
                      ...
                      <a className="mt-3" style={{lineHeight:"1.2"}}    href="/smart-contact">Privilege Access Management (PAM)t</a>
            ...
            <li className="servicNav">
              <Link  style={{lineHeight:"1.2"}}  to="/Solution">Security Assessment (VA & Tools)</Link>
              <ul>
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="https://pecb.com/en">Tenable (multiple solutions)</Link>
                    </li>
                    <li>
                      <Link to="https://arscert.com/certification/">Core Impact</Link>
                    </li>
                  </ul>
                </li>
                <li>
                  <Link style={{lineHeight:"1.2"}}   to="/association-partners">Cyber Security Visibility & management Solutions</Link>
                  <ul>
                  <li>
                      ...
                      Foundation track - (Corporate) <i className="fas fa-caret-right "></i>
                           <span className="AnchorHide"> 
                              <a href='/service'>Basic</a>
                                ...
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i> Information Security Fundamentals (FIS)</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i> Information Security Fundamentals (FIS)</a>


                                <a href='/service'> Advance</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  	Computer Forensic Fundamentals (CFF)</a>
                    ...
                    Network Defense and Operations - (Corporate)<i className="fas fa-caret-right "></i>
                           <span className="AnchorHide"> 
                              <a href='/service'>Basic</a>
                                ...
                                <a href='/service'>Intermediate</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i> 	EC-Council Disaster Recovery Professional (EDRP-312-76)</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  	EC-Council Certified Incident Handler (ECIH-212-89)</a>


                                <a href='/service'> Advance</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  Securing Windows Infrastructure (CAST-616)</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>   	Advance Network Defense (CAST-614)</a>
                       ...
                       Software Security - (Corporate) <i className="fas fa-caret-right "></i>
                           <span className="AnchorHide"> 
                              <a href='/service'>Basic</a>
                                ...
                                <a href='/service'>Intermediate</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i> 	EC-Council Certified Secure Programmer JAVA (ECSP-312-94) </a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  EC-Council Certified Secure Programmer .Net (ECSP-312-93)</a>


                                <a href='/service'> Advance</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i> 	Advanced Penetration testing (CAST-611)</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  Securing Windows Infrastructure (CAST-616)</a>
                      ...
                      Vulnerability Assessment & Penetration Testing (VA & PT) - (Corporate)  <i className="fas fa-caret-right "></i>
                           <span className="AnchorHide"> 
                              <a href='/service'>Basic</a>
                                ...
                                <a href='/service'>Intermediate</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i> 	Licensed Penetration Tester (LPT-412-79)</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i> 	EC-Council Certified Security Analyst (ECSA-412-79) </a>


                                <a href='/service'> Advance</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  	Advanced Penetration testing (CAST-611)</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  	 Hacking and Hardening Your Corporate Web Application (CAST-613)</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>   Securing Windows Infrastructure (CAST-616)</a>
                   ...
                   Cyber Forensic - (Corporate) <i className="fas fa-caret-right "></i>
                           <span className="AnchorHide"> 
                              <a href='/service'>Basic</a>
                                ...
                                <a href='/service'>Intermediate</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i> EC-Council Certified Incident Handler (ECIH-212-89)</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  	Computer Hacking Forensic Investigator (CHFI-312-49)</a>


                                <a href='/service'> Advance</a>
                                <a href="/" className="mx-3">  <i   className="fas fa-circle iconStyle "> </i>  	Advanced Mobile Forensics And security (CAST-612)</a>
            ...
            <li className="menu-item-has-children servicNav">
              ...
              <ul>
                <li className="menu-item-has-children">
                  ...
                  <ul>
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/certified-ethical-hacker">
                        Certified Ethical Hacker (CEH)
                      </Link>
                    </li>
                    <li>
                      <Link  style={{lineHeight:"1.2"}}  to="/certified-penetration">
                        Certified Penetration Testing Professional(CPENT)
                      </Link>
                    </li>
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/certified-information-system">
                        Certified Information Systems Auditor(CISA)
                      </Link>
                    </li>
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/computer-hacking">
                    ...
                    <li>
                      <Link  style={{lineHeight:"1.2"}}  to="/giac-penetration">
                        GIAC Penetration Tester(GPEN)
                      </Link>
                    </li>
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/giac-web-application">
                ...
                <li className="menu-item-has-children">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/certified-threat">
                        Certified Threat Intelligence Analyst(CTIA)
                      </Link>
                    </li>
                    
                    <li>
                      <Link style={{lineHeight:"1.2"}}   to="/certified-information-security">
                        Certified Information Security Manager(CISM)
                      </Link>
                    </li>
                    <li>
                      <Link  style={{lineHeight:"1.2"}}  to="/certified-information-system-security">
...
<li>
      ...
      <div className="mobile-nav__content">
        ...
        <div className="logo-box">
          <Link to="/" aria-label="logo image"><img src="assets/images/images-removebg-preview.png" width="78"
              height="53" alt="Cretech"/></Link>
        </div>
        ...
        <ul className="mobile-mobile-nav__country">
          ...
          <select className="mobileTopbar text-light"
                ...
                >
                <option value="1"><Link to="/">BD</Link></option>
                <option value="2"><Link to="/">USA</Link></option>
                <option value="3"><Link to="/">Australia</Link></option>
                <option value="4"><Link to="/">Germany</Link></option>
               </select>             
        ...
        <ul className="mobile-nav__contact list-unstyled">
        {
          ...
          <li>
            ...
            <>
                <li>
                <i className="fa fa-envelope"></i>
                <Link to="mailto:info@righttime.biz">coo.usa@righttime.biz</Link>
            </li>
            <li>
            ...
            :show==='3'?
              <>
                  <li>
                    <i className="fa fa-envelope"></i>
                    <Link to="mailto:info@righttime.biz">coo.au@righttime.biz</Link>
                </li>
                <li>
                    <i className="fa fa-map-marker"></i>
            ...
            <>
                <li>
                    <i className="fa fa-envelope"></i>
                    <Link to="mailto:info@righttime.biz">coo.de@righttime.biz</Link>
                </li>
                <li>
                    <i className="fa fa-map-marker"></i>
