export const OfferData = [
    ...
    },
    {
        ...
        description: ' Confirm systems that fall under the VAPT scope and articulate the scope statement.',
         image: 'https://www.technovus.com/wp-content/uploads/2019/10/PCI-DSS-Compliance.jpg',
        header:"VAPT"
    },

    {
        ...
        description: 'Identify gaps including VA & PT (internal & External) in your organization’s security controlsystems and environment vis-à-vis VAPT requirements',
         image: 'https://www.technovus.com/wp-content/uploads/2019/10/PCI-DSS-Compliance.jpg',
        header:"VAPT"
    },
    ...
    },
    {
        ...
        description: 'Assist for Technical Documentation Modify/Formulate/Edit policies and procedures as per VAPT requirements which are then finalized by relevant team and then approved by the top management. And assist for implementing necessary policies for your organization',
         image: 'https://www.technovus.com/wp-content/uploads/2019/10/PCI-DSS-Compliance.jpg',
        header:"VAPT"
    },
