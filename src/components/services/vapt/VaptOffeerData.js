export const OfferData = [
...

  {
    ...
    description:
      "Identify gaps including VA & PT (internal & External) in your organization’s security controlsystems and environment vis-à-vis VAPT requirements",
    image:
      "https://www.technovus.com/wp-content/uploads/2019/10/PCI-DSS-Compliance.jpg",
    header: "VAPT",
  },
  ...
  },
  {
    ...
    description:
      "Assist client for detailed remediation strategies including the recommendation of compensating controls as applicable that can help your organization strengthen the security posture of the environment.",
    image:
      "https://www.technovus.com/wp-content/uploads/2019/10/PCI-DSS-Compliance.jpg",
    header: "VAPT",
  },
  {
    ...
    description:
      "Assist for Technical Documentation Modify/Formulate/Edit policies and procedures as per VAPT requirements which are then finalized by relevant team and then approved by the top management. And assist for implementing necessary policies for your organization",
    image:
      "https://www.technovus.com/wp-content/uploads/2019/10/PCI-DSS-Compliance.jpg",
    header: "VAPT",
  },

  {
    ...
    description:
      "After a reasonable maturation period, our distinct team of experts conducts a Preassessment (internal audit) of your setup to check whether the suggested measures are implemented and in place",
    image:
      "https://www.technovus.com/wp-content/uploads/2019/10/PCI-DSS-Compliance.jpg",
    header: "VAPT",
  },
