            ...
            <div>
                ...
                <div className='dipt-architecture-content-parent'>
                    ...
                    <div id="page3" className={`swift-architecture-page ${activePage === 'page3' ? 'activepage' : ''}`}>
                        <div className='swift-architecture-data-container'>
                            <div className='dipt-swift-architecture-img-container'>
                                <img src="/assets/images/services/SwiftCyber/type3.png" alt="" />
                            </div>
                            <div>
                                <div className='dipt-swift-architecture-data-mini-container'>
                                    <h3 className='dipt-swift-architecture-header-data'>Architecture Type A3 (SWIFT Connector)</h3>
                                    <p className='dipt-swift-architecture-p-data'>A Swift connector is employed within the user’s environment to enable application-to-application communication with a service provider’s interface (like a service bureau or a Group Hub) or Swift services (e.g., Alliance Cloud or Alliance Lite2), without owning any messaging or communication interface.
                                    </p>
                                    <p className='dipt-swift-architecture-p-data'>This setup may also incorporate a GUI solution for user-to-application interaction, requiring the implementation of additional controls related to the GUI. Furthermore, this architecture encompasses scenarios where the user’s Swift connector is hosted or managed by a third party or service provider, which should be regarded as an outsourcing agent in these instances.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="page4" className={`swift-architecture-page ${activePage === 'page4' ? 'activepage' : ''}`}>
                        <div className='swift-architecture-data-container'>
                            <div className='dipt-swift-architecture-img-container'>
                                <img src="/assets/images/services/SwiftCyber/type4.png" alt="" />
                            </div>
                            <div>
                                <div className='dipt-swift-architecture-data-mini-container'>
                                    <h3 className='dipt-swift-architecture-header-data'>Architecture Type A4 (Customer Connector)</h3>
                                    <p className='dipt-swift-architecture-p-data'>Architecture A4, known as the Customer Connector, applies to users without a direct Swift presence, utilizing a server within their environment (e.g., a file transfer solution or middleware server) to establish external application-to-application connections with Swift-related applications or solutions provided by a service bureau, Business Connect, Lite2 Business Application provider, or Group Hub. This architecture also covers cases where the customer connector is hosted or operated by a third party or service provider, acting as an outsourcing agent.</p>
                                    <p className='dipt-swift-architecture-p-data'>The framework includes using file transfer or middleware servers for connections not through WAN or VLAN, without a Swift connector, and applies to setups where customer connectors use Swift APIs for direct transactions with Swift services. Additionally, it may involve GUI solutions requiring GUI-specific controls. Like other architectures, while back-office systems generating transactions usually fall outside CSP/CSCF scope, implementing security controls based on industry frameworks and CSCF principles is advised to mitigate broader transaction chain risks.</p>
                                </div>
                            </div>
                        </div>
                    </div>
