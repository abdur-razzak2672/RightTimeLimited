                ...
                <div className="row">
                    <div className="col-md-6">
                        <button className={`  mt-5 px-5 py-2 w-100 ${activePage === 'page1' ? 'dipt-building-blocks-buttons' : ''}`} onClick={() => showPage('page1')}><span className="building-blocks-btn-p">
                            Swift Cybersecurity Consultation</span></button>
                    </div>
                    <div className="col-md-6">
                        <button className={`  mt-5 px-5 py-2 w-100 ${activePage === 'page2' ? 'dipt-building-blocks-buttons' : ''}`} onClick={() => showPage('page2')} ><span className="building-blocks-btn-p">
                            Swift CSP Assessment</span></button>
                    </div>
                        ...
                        activePage === 'page2' ? (
                            <div>
                                                ...
                                                <div className="section-title text-center">
                                                    <div className="expanedItem ">
                                                        <div className=" expaneditems1">
                                                            <Accordion className="shadaow">
                                                                <Accordion.Item className="my-3" eventKey="1">
                                                                    <Accordion.Header>Right Time Expertise</Accordion.Header>
                                                                    <Accordion.Body>
                                                                        Thanks to Right Time Limited broad expertise, experience and proven record of assisting organisations in both the implementation and the assessment of Swift security controls, you can rely on both enhanced security and compliance with the CSP framework.
                                                                    </Accordion.Body>
                                                                </Accordion.Item>
                                                            </Accordion>
                                                            <Accordion >
                                                                <Accordion.Item className="my-3" eventKey="1">
                                                                    <Accordion.Header>Tailored approach</Accordion.Header>
                                                                    <Accordion.Body>
                                                                        Right Time Limited tailors its work to each individual client’s needs, to ensure our solutions add value where you most need it. Ranging from implementing an ISO27K-compliant GRC security program or a third party security management system to providing DORA and NIS2 assessments and implementations – always in a pragmatic way, tailored to your needs.
                                                                    </Accordion.Body>
                                                                </Accordion.Item>
                                                            </Accordion>
                                                        ...
                                                        <div className="expaneditems1 ">
                                                            <Accordion >
                                                                <Accordion.Item className="my-3" eventKey="1">
                                                                    <Accordion.Header>Well-versed in Swift CSP </Accordion.Header>
                                                                    <Accordion.Body>

                                                                        Our experts are well-versed in the Swift CSP controls and implementation guidelines, on top of their strong financial sector focus. This enables them to understand the complex regulatory landscape and the evolving cyber security threats.                    </Accordion.Body>
                                                                </Accordion.Item>
                                                            </Accordion>
                                                            <Accordion >
                                                                <Accordion.Item className="my-3" eventKey="1">
                                                                    <Accordion.Header>Relevant certifications</Accordion.Header>
                                                                    <Accordion.Body>

                                                                        All our Lead Auditors have proven experience in Swift CSP assessments, IT audits and ISO27K implementations and assessments, and have relevant certifications including the Swift Certified Assessors certification and a combination of CISA, CISM, CISSP, ISO27K Lead Auditor, etc. Furthermore, our low partner-to-staff ratio means high involvement and guidance from partners and experienced staff, and a solid and stable team to perform the assessments.                    </Accordion.Body>
                                                                </Accordion.Item>
                                                            </Accordion>
                                ...
                                <section className="dipt-our-assesment-process-section-container">
                                    <div>
                                        <h3 className="dipt-our-assesment-process-header">Our Methodology </h3>
                                    </div>
                            ...
                            <div>
                                <div className="row">
                                    <div className="col-md-6">
                                        <h3>What happens if you don't submit your Swift CSCF 2024 attestation?</h3>
                                        <img className="rounded" style={{ width: "100%" }} src="/assets/images/services/SwiftCyber/Pic01.png" alt="" />

                                    </div>

                                    <div className="col-md-6">
                                        <p className="mt-5 pt-5">The introduction of Swift’s Customer Security Programme Assessor Certification marks a substantial advancement in bolstering the security of financial messaging services. This framework not only boosts the confidence and consistency of Swift users but also grants them access to certified assessments. Failing to comply with the standards, Swift holds the right to report the organizations to the industry regulators.</p>
                                    </div>
                                </div>

                                <div className="my-5">
                                    <h3>Tips for CSCF v2024 implementation:</h3>
                                    <p>Right Time Limited performed numerous assessments in 2023. Our experience across our assessments shows that getting scoping, planning and definitions right from the outset is vital for a successful assessment. Furthermore, based on our reviews, we believe the following key areas to be most likely to cause non-compliances in 2024: </p>
                                    <div className="mt-5 row">
                                        <div className="col-md-4">
                                            <Accordion className="shadaow w-100">
                                                <Accordion.Item className="my-3" eventKey="1">
                                                    <Accordion.Header>Third-Party Risk Management (TPRM)</Accordion.Header>
                                                    <Accordion.Body>
                                                    
Many organisations have identified and listed their third parties and established a TPRM policy. However, often procedures on how to perform third-party risk assessments are not established or properly implemented, such as performing periodic reviews of the risk assessment and SLA reviews with critical suppliers.  

This is especially important given that these procedures should now be expanded to also cover a review/assessment of the supplier’s implementation of the CSP controls. Keep in mind that your TPRM processes will also need to comply with DORA by January 2025.                                                     </Accordion.Body>
                                                </Accordion.Item>
                                            </Accordion>
                                        </div>
                                        <div className="col-md-4">
                                            <Accordion className="shadaow w-100">
                                                <Accordion.Item className="my-3" eventKey="1">
                                                    <Accordion.Header>Cybersecurity Awareness and Training</Accordion.Header>
                                                    <Accordion.Body>
...
Consider using automated phishing simulation tools and short automated training videos in addition to longer classroom trainings to maximise the effectiveness of the awareness program.                                                     </Accordion.Body>
                                                </Accordion.Item>
                                            </Accordion>
                                        </div>
                                        <div className="col-md-4">
                                            <Accordion className="shadaow w-100">
                                                <Accordion.Item className="my-3" eventKey="1">
                                                    <Accordion.Header>Business Continuity testing & Cyber Incident Response Planning</Accordion.Header>
                                                    <Accordion.Body>
                                                    
Given the upcoming implementation of DORA in January 2025 and its requirements on Incident Management and Operational Resilience Testing, we believe organisations should place more focus on Incident Response Planning. This will ensure their implementation is not only in line with Swift CSP but also with DORA. If your organisation is subject to DORA, assessors are likely to start reviewing processes with a DORA mindset even before it is implemented. 

Tip: ask your CSP assessor if they have knowledge of DORA and if they can perform a light DORA review of these processes to give you an idea of whether you would be DORA-compliant.                                                     </Accordion.Body>
                                                </Accordion.Item>
                                            </Accordion>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-primary rounded p-5">
                                    <div  >
                                        <p className="text-light text-center">ECS CSP Service are crafted to offer essential support. enabliling tangible enhancemenys to your organizations cyber security posture</p>
                                        <a className="d-flex justify-content-center" href="/contact-us">
                                            <button className="btn btn-warning text-light rounded px-3">Contact Us</button>
                                        </a>
                                    </div>
