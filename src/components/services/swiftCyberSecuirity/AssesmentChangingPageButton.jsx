    ...
    return (
        <div>
            <div>
                ...
                <div className='dipt-assesment-content-parent mt-5'>
                        ...
                        <div className='assesment-content-data-container'>
                            ...
                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Kick-Off Meeting & Planning</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. Understanding the context and scope of the project (Business Understanding)<br />
                                        2. Methodology Presentation.<br />
                                        3. Team Introduction
                                    </p>
                                </div>
                            </div>
                    ...
                    <div id="page2" className={`swift-architecture-page ${activePage === 'page2' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>
                            ...
                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Assessment Scope
                                        Finalizing</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. Detailed Questionnaire is shared with the teams to aid in the scope definition.<br />
                                        2. Planning and preparation of the audit and objectives.<br />
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="page3" className={`swift-architecture-page ${activePage === 'page3' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>
                            ...
                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Information Collection
                                        (Collect Evidence and
                                        Artifacts)</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1.  Meeting with primary point of contact to go through the list of requirements. <br />
                                        2.  Request for documents that provide proof of control implementation<br />
                    ...
                    <div id="page4" className={`swift-architecture-page ${activePage === 'page4' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>
                            ...
                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Initial/Readiness
                                        Assessmen</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. Analysis of the documents provided                       <br />
                                        2. Analyze the risks in the information security posture.               <br />
                    ...
                    <div id="page5" className={`swift-architecture-page ${activePage === 'page5' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>
                            ...
                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Documentation/Evidence
                                        Review</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. Evaluates the received documents & identify interview requirements.<br />
                                        2. Review of the evidence collected to assess their maturity, in line with the compliance.
                    ...
                    <div id="page6" className={`swift-architecture-page ${activePage === 'page6' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>

                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Validate SWIFT
                                        Architecture</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. Assist organization to identify and validate SWIFT architecture.<br />
                                        2. Identify zones and components as per the assessment requirements
                    ...
                    <div id="page7" className={`swift-architecture-page ${activePage === 'page7' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>

                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>In-Depth Analysis</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. Detailed work through with key staff.<br />
                                        2. Request for additional evidence.<br />
                                        3. Perform Mandatory & Advisory Control Validation to understand the control applicability as
                                        per the environment.<br />
                                        4. Conducting through systems analysis to evaluate data flow and possible leakage (data follow
                                        assessment).<br />
                                        5. Identify critical vulnerabilities in the systems with robust testing approach (Security
                                        Assessment i.e. VA & PT.
                    ...
                    <div id="page8" className={`swift-architecture-page ${activePage === 'page8' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>

                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Reporting &
                                        recommendation</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. Provide assessment report with explicit recommendation to resolve any compliance gaps.
                    ...
                    <div id="page9" className={`swift-architecture-page ${activePage === 'page9' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>

                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Remediation Support
                                        including Documentation</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. As per the assessment RightTime Will provide remediation support for complying with SWIFT
                                        Cybersecurity Framework).<br />
                                        2. Assisting to ease out the documentation process during the assessment process (if any).
                    ...
                    <div id="page10" className={`swift-architecture-page ${activePage === 'page10' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>

                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Resolution of potential
                                        gaps/ Follow Up</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. Follow up on resolution of remaining gaps.<br />
                                        2. Collect missing evidence.<br />
                    ...
                    <div id="page11" className={`swift-architecture-page ${activePage === 'page11' ? 'activepage' : ''}`}>
                        <div className='assesment-content-data-container'>

                            <div>
                                <div className='dipt-assesment-process-data-mini-container'>
                                    <h3 className='dipt-assesment-process-header-data'>Final Assessment</h3>
                                    <p className='dipt-assesment-process-p-data'>
                                        1. 2nd Assessment to assess closer of non-conformities.<br />
                ...
                <img style={{width:"100%"}} src="/assets/images/services/SwiftCyber/element.jpg" alt="" />

                <h3 className='mt-5'>Re-Assessment Process</h3>
                <p className='text-justify'>In the update of the framework, more precisely in the accompanying IAFv2023, the possibility of ReAssessment was clarified. Previously known to SWIFT users as "Delta Assessment", this process allows
the reuse of previous assessment results. This possibility is based on some conditions that can be
assessed with the following questions:
The initial question to be answered before use must always be a general assessment: Can the audit
results from the previous year be used again, in other words, can these results still be relied upon?
Impediments to using the audit results from the previous year can be, for example, major changes to
the environment, new SWIFT services, new providers or new architecture types in the environment.
If the results are not usable for the reasons listed, a new full assessment must be performed in which
each individual control must be fully tested.
If there were no changes and the results can be used generally, further assessments for each individual
control are necessary:<br/><br/>
1. Was the assessment performed against the previous or the current version? They are valid
only if they have already been performed on the basis of the new version of the framework.<br/>
2. Was the result collected in the previous year or are you already basing it on the result from
the year before last year? Only results from the previous year may be used.<br/>
3. Have changes been made to the control itself within the framework? Has the subject of the
control changed? The results are only valid if the control itself has remained the same.<br/>
4. Is the design of the environment or the implementation unchanged? Both must have remained<br/>
unchanged so that the results may be used for the reassessment process.</p>
<div className='d-flex justify-content-center'>
<img className='rounded'  style={{width:"60%"}} src="/assets/images/services/SwiftCyber/re.png" alt="" />
