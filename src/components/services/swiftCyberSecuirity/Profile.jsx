                ...
                <div>
                    ...
                    <div  >
                        <div  className="row" >
                            ...
                            <img className='rounded-5' style={{ width: "30%", height: "150px" }} src="/assets/images/team/Mohammad Tohidur Rahman Bhuiyan.jpg" alt="" /> 
                            <div className="service-card-three__content mt-3 mx-3">
                                <h4 className="pt-3"> Mohammad Tohidur Rahman Bhuiyan
                                </h4>
