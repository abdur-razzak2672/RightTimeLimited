          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <div className="blog-details__content">
                <p>
                  The power sector is one of the most frequently targeted and
                  first to respond to cyber threats with mandatory controls. But
                  threats continue to evolve, reaching into industrial control
                  systems and supply chains, and requiring even greater efforts
                  to manage risk.
                </p>
                <br />
                ...
                <p>
                  This is how our power sector cybersecurity consultants will
                  assist to manage cybersecurity risks -
                  <ul>
                  ...
                  Plus many other control system security standards, regulations
                  and best practice guidelines worldwide.
                </p>
              </div>
              <br />
              <a href="contact-us">
