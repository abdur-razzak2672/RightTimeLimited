...
function VaAsService() {
  return (
    ...
    <ul className="thm-breadcrumb list-unstyled">
            ...
            <li>	Vulnerability Assessment (VA) As A Service</li>
        </ul>
        <h2 className="page-header__title">	Vulnerability Assessment (VA) As A Service</h2>
    </div> 
</div> 
