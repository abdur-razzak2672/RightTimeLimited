...
function ManagedNextgen() {
  return (
    ...
    <ul className="thm-breadcrumb list-unstyled">
            ...
            <li>Managed
                        Nextgen Firewall as A Service</li>
        </ul>
        <h2 className="page-header__title">Managed
                        Nextgen Firewall as A Service</h2>
    </div> 
</div> 
