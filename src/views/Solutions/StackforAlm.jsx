  ...
  return (
    ...
    ></div> */}
        <div className="container">
          ...
          <h2 className="page-header__title">	Dx Stack for ALM & Infrastructure</h2>
        </div>
        ...
        <div className="container mt-5">
          <div className="row">
            <div className="col-lg-8 textJustify">
              ...
              <img className='rounded mb-2' width="100%" height=" 400px" src="/assets/images/solutions/Dx_Stack_for_ALM.jpg" alt="img" />
          ...
          <p>With the Dx Stack for ALM & Infrastructure offered by "Right Time Limited" through its partnership with iValue InfoSolutions Pvt. Ltd, organizations can achieve higher efficiency, agility, and reliability in their software development processes while effectively managing their IT infrastructure. This comprehensive solution empowers organizations to stay competitive in the fast-paced technology landscape and achieve success in their digital transformation journey.   </p>
          <p>   </p>
          </div>
