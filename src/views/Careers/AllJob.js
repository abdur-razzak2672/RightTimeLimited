      ...
      <div className="page-header">
        ...
        <div className="container">
          ...
          <p className="text-light">
            At Bottomline everybody makes a difference and everybody plays a
            part. We are looking for passionate people to join our team who are
            committed to delighting our customers no matter their role and who
            want to work hard, Communicate, Innovate, Win and Grow. Our culture
            is something we cultivate - we all own and create each day and it is
            an important key to our success.
          </p>
          <p className="text-light">
            We have created an environment where we foster growth and
            innovation, where our people are encouraged to be brave and curious.
            Our future is bright - Will you join us?
          </p>
        </div>
      </div>
