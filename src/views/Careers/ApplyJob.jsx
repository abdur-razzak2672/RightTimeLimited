    ...
    <div className="container">
      <div className="d-flex justify-content-between">
        <div>
          ...
          <p>
            at Right Time Limited <a href="/view-job">(view All Job)</a>
          </p>
        </div>
      </div>
      ...
      <div className="mt-3">
        <p>
          Bottomline is at the forefront of digital transformation. We are a
          growing global market leader uniquely equipped to address the changing
          needs of how businesses pay and get paid. Our culture of Working with
          and for each other enables us to delight our customers. We empower our
          teams to think like owners driving customer satisfaction, helping them
          grow their business and win in their markets.
        </p>
        ...
        <p>
          Bottomline Technologies is seeking a Financial Analyst to join the
          Financial Planning and Analysis group and play a key role in the
          strategic financial direction of the company. The position reports to
          the Director of Finance and will include day-to-day interaction with
          other members of senior management and Thoma Bravo operating advisors
        </p>
        ...
        <p>
          The ability to independently manage multiple projects and requests
          effectively
        </p>
        ...
        <p className="mt-5">
          You’ll love Bottomline because in everything we do we seek to delight
          our customers and we are passionate about building a company of which
      ...
      >
        ...
        <Form>
          ...
          <Form.Group controlId="formFileMultiple" className="mb-3">
            ...
            <Form.Label>
              Allow fromate are .docx, .docs, .pdf and maxumum size 10MB
            </Form.Label>
          </Form.Group>
          ...
          <Form.Group controlId="formFileMultiple" className="mb-3">
            <Form.Label>
              If you're an employee referral, please provide the name of the
              employee
            </Form.Label>
            <Form.Control type="text" multiple />
          </Form.Group>
          ...
          <Form.Group as={Col} controlId="formGridEmail">
            <Form.Label>
              Do you now or have you in the past worked for Bottomline
              Technologies? *
            </Form.Label>
            <Form.Select aria-label="Default select example">
              <option>Bangladesh</option>
          ...
          <p>
            ...
            file. As set forth in Bottomline Technologies’s Equal Employ
          </p>
          ...
          <a
            href="/apply-job"
            className=" mt-5  thm-btn cta-two__btn rounded-2"
          >
            <span>
              Submit<i className="mx-1 fas fa-arrow-right"></i>
            </span>
          </a>
        </Form>
      </div>
