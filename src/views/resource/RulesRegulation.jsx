        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-10 mx-auto">
              ...
              <p className="text-dark">Right Time Limited specializes in navigating complex cybersecurity regulations, including GDPR, HIPAA, and CCPA, helping clients operationalize compliance while maintaining agility.</p>
              <ul>
