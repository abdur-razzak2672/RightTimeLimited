  ...
  const infographicsData = [
    {
      ...
      description: "Learn how to create unbreakable passwords and implement multi-factor authentication for maximum security.",
      size: "2.4 MB",
      badgeColor: "primary"
    },
    {
      ...
      description: "Identify common phishing tactics and learn how to protect yourself from email scams and fraudulent websites.",
      size: "3.1 MB",
      badgeColor: "warning"
    },
    {
      ...
      description: "Essential strategies for safeguarding your personal information and maintaining privacy in the digital age.",
      size: "2.8 MB",
      badgeColor: "success"
    },
    {
      ...
      description: "Understand manipulation tactics used by cybercriminals and learn how to recognize social engineering attacks.",
      size: "2.6 MB",
      badgeColor: "danger"
    },
    {
      ...
      description: "Best practices for maintaining cybersecurity while working from home or any remote location.",
      size: "3.5 MB",
      badgeColor: "info"
    },
    {
      ...
      description: "Comprehensive overview of current cybersecurity threats, statistics, and emerging attack vectors.",
      size: "4.2 MB",
      badgeColor: "dark"
    }
  ]
     ...
     <div className="container">
       <div className="row">
         <div className="col-lg-8 mx-auto text-center mb-5">
           <h2 className="display-4 fw-bold text-primary mb-4">Cybersecurity Infographics</h2>
           <p className='lead text-dark'>
             Explore our comprehensive collection of cybersecurity infographics designed to simplify complex security concepts. 
             These visual resources provide actionable insights, statistics, and best practices to help individuals and organizations 
             ...
             <div className="card h-100 shadow-sm border-0 infographic-card">
               ...
               <div className="card-body">
                 ...
                 <div className="d-flex justify-content-between align-items-center">
                   <small className="text-muted">PNG • {infographic.size}</small>
                   <div>
                     <button 
     ...
     <div className="container">
       <div className="row text-center">
         <div className="col-lg-3 col-md-6 mb-4">
           <div className="h2 text-primary fw-bold">{infographicsData.length}+</div>
         ...
         <div className="col-lg-3 col-md-6 mb-4">
           <div className="h2 text-primary fw-bold">{categories.length - 1}</div>
         ...
         <div className="row mt-4">
           <div className="col-12 text-center">
             <div className="alert alert-info d-inline-block">
               ...
               Showing {filteredInfographics.length} result{filteredInfographics.length !== 1 ? 's' : ''}
     ...
     <div className="container">
       <div className="row">
         <div className="col-12 text-center mb-5">
           <h3 className="display-5 fw-bold text-primary">Featured Security Topics</h3>
           <p className="lead">Stay informed about the latest cybersecurity trends and threats</p>
         </div>
       </div>
       <div className="row g-4">
         <div className="col-lg-4">
           <div className="text-center">
             ...
             <p className="text-muted">Learn about the zero trust security model and how to implement it in your organization.</p>
           </div>
         </div>
         <div className="col-lg-4">
           <div className="text-center">
             ...
             <p className="text-muted">Explore how artificial intelligence is transforming cybersecurity defense and attack strategies.</p>
           </div>
         </div>
         <div className="col-lg-4">
           <div className="text-center">
             ...
             <p className="text-muted">Best practices for securing cloud infrastructure and protecting data in cloud environments.</p>
           </div>
         </div>
       </div>
     </div>
     ...
     <div className="container">
       <div className="row">
         <div className="col-lg-8 mx-auto text-center">
           <h3 className="display-6 fw-bold mb-4">Stay Updated with Latest Security Resources</h3>
           <p className="lead mb-4">
             Subscribe to our newsletter and get the latest cybersecurity infographics, guides, and resources delivered directly to your inbox.
           </p>
           <div className="row">
       ...
       <div className="row g-3">
         <div className="col-lg-3 col-md-6">
           <div className="card border-0 h-100 text-center p-3">
             ...
             <p className="text-muted small">Comprehensive cybersecurity guides and best practices</p>
             <a href="#" className="btn btn-outline-primary btn-sm">View Guides</a>
           </div>
         </div>
         <div className="col-lg-3 col-md-6">
           <div className="card border-0 h-100 text-center p-3">
             ...
             <p className="text-muted small">Interactive video tutorials on cybersecurity topics</p>
         ...
         <div className="col-lg-3 col-md-6">
           <div className="card border-0 h-100 text-center p-3">
             ...
             <h6>Security News</h6>
             <p className="text-muted small">Latest cybersecurity news and threat intelligence</p>
             <a href="#" className="btn btn-outline-primary btn-sm">Read News</a>
           </div>
         </div>
         <div className="col-lg-3 col-md-6">
           <div className="card border-0 h-100 text-center p-3">
             ...
             <p className="text-muted small">Free tools and resources for cybersecurity professionals</p>
             <a href="#" className="btn btn-outline-primary btn-sm">Explore Tools</a>
           </div>
         </div>
       </div>
     </div>
