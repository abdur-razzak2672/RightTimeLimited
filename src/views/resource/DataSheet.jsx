  ...
  const dataSheets = [
    {
      ...
      description:
        "Complete SaaS security solution protecting your cloud applications from advanced threats with AI-powered detection and response capabilities.",
      image:
    ...
    },
    {
      ...
      description:
        "Revolutionary SIEM solution that simplifies security data onboarding and provides real-time threat detection with advanced analytics.",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive security assessment framework for AI systems, ensuring robust protection against emerging AI-specific threats.",
      image:
    ...
    },
    {
      ...
      description:
        "Next-generation endpoint protection with behavioral analysis, machine learning, and real-time threat prevention capabilities.",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive identity protection solution implementing zero trust principles with advanced authentication and access controls.",
      image:
    ...
    },
    {
      ...
      description:
        "Rapid incident response services with expert cybersecurity professionals available around the clock for immediate threat containment.",
      image:
    ...
    },
    {
      ...
      description:
        "Advanced data protection solution with intelligent classification, monitoring, and prevention of sensitive data breaches.",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive threat intelligence platform providing real-time insights and proactive threat hunting capabilities.",
      image:
    ...
    },
    {
      ...
      description:
        "Advanced network security gateway providing comprehensive protection against network-based attacks and intrusions.",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive framework for maintaining compliance with industry standards and managing cybersecurity risks effectively.",
      image:
    ...
    },
    {
      ...
      description:
        "Expert cybersecurity consulting services helping organizations build robust security strategies and implement best practices.",
      image:
    ...
    },
    {
      ...
      category: "Cloud Security",
      description:
        "Modern cloud-native security architecture designed for scalable protection of containerized and serverless applications.",
      image:
        "https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      downloadUrl: "#",
      pages: "8 pages",
    ...
    <div>
          ...
          <div className="row">
            <div className="col-lg-8 mx-auto ">
              ...
              <p className="lead text-dark mb-4">
                In-depth fact sheets with detailed information on Right Time
                Limited's comprehensive suite of cybersecurity products and
                services. Get the technical specifications, features, and
                benefits you need to make informed security decisions.
              </p>
        ...
        <div className="container">
          <div className="row mb-5">
            <div className="col-12 text-center">
              <h3 className="display-5 fw-bold orange mb-3">
                Featured Data Sheets
              </h3>
              <p className="lead text-muted">
                Our most popular and recently updated cybersecurity solution
                overviews
              </p>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-12 text-center py-5">
                ...
                <p className="text-muted mb-4">
                  No data sheets match your current search criteria. Try
          ...
          <div className="row">
            <div className="col-lg-8 mx-auto text-center">
              ...
              <p className="lead mb-4">
                Can't find the exact information you're looking for? Our
                cybersecurity experts can create customized data sheets tailored
                to your specific requirements and use cases.
              </p>
      ...
      <section className="py-5 bg-light">
        <div className="container">
          <div className="row mb-5">
            <div className="col-12 text-center">
              <h3 className="display-6 fw-bold orange mb-3">
                Discover More at Our Resource Center
              </h3>
              <p className="lead text-muted">
                Explore additional cybersecurity resources and tools
              </p>
            </div>
          </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card border-0 h-100 text-center resource-card">
                <div className="card-body">
                  ...
                  <p className="card-text text-muted">
                    Free cybersecurity tools and utilities for professionals
                  </p>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card border-0 h-100 text-center resource-card">
                <div className="card-body">
                  ...
                  <p className="card-text text-muted">
                    In-depth research and analysis on cybersecurity topics
                  </p>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="card border-0 h-100 text-center resource-card">
                <div className="card-body">
                  ...
                  <p className="card-text text-muted">
                    Live and recorded cybersecurity training sessions
                  </p>
