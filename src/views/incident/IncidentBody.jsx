  ...
  const cards = [
    {
      id: 1,
      imageSrc:
        "https://media.kasperskycontenthub.com/wp-content/uploads/sites/103/2021/09/03121451/incident_response-e1630685709431.png",
      title: "Incident Response",
      description:
        "Right Time Limited provides prompt and expert incident response services to help organizations mitigate the impact of security incidents... ",
      additionalContent:
    ...
    },
    {
      id: 2,
      imageSrc:
        " https://www.flir.com/globalassets/news/news-center/_blogmigrationfiles/forensic-investigations-using-thermography-and-steam/print.jpg   ",
      title: " Forensic Investigation  ",
      description:
        " In the event of a security breach or incident, Right Time Limited conducts thorough forensic investigations to identify the root cause...  ",
      additionalContent:
    ...
    },
    {
      ...
      description:
        " Right Time Limited offers proactive threat hunting services to identify and neutralize potential threats before they escalate into full-blown incidents...  ",
      additionalContent:
    ...
    },
    {
      id: 4,
      imageSrc:
        " https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCvOPbrku0HDMDXVurbky6hVIpTK5bhr1uxQ&usqp=CAU   ",
      title: " Incident Readiness and Planning  ",
      description:
        "Right Time Limited assists organizations in developing and refining their incident response plans, ensuring they are well...   ",
      additionalContent:
    ...
    },
    {
      id: 5,
      imageSrc:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRal4KSZ7GzfwhPb2-g-pmpEeNsg2lrfIydSQ&usqp=CAU    ",
      title: " Incident Reporting and Analysis  ",
      description:
        " Right Time Limited helps organizations compile comprehensive incident reports, documenting the details of the incident...  ",
      additionalContent:
    ...
    },
    {
      id: 6,
      imageSrc:
        "  https://www.h-x.technology/wp-content/uploads/2021/01/H-X-MDR-components-2.jpg  ",
      title: " Continuous Monitoring and Threat Intelligence  ",
      description:
        "  Right Time Limited offers continuous monitoring services, leveraging advanced technologies and threat ... ",
      additionalContent:
      ...
      <section className="container">
        <div className=" mt-4">
          ...
          <p className="text-dark">
            Right Time Limited Incident Services encompass incident response,
            forensic investigation, threat hunting, incident readiness and
            planning, incident reporting and analysis, as well as continuous
            monitoring and threat intelligence. Its comprehensive approach aims
            to help organizations effectively manage security incidents,
            minimize damage, and enhance their overall security posture in the
      ...
      <section className="d-flex justify-content-center">
        <div>
          <h3 className="text-dark mt-4">
            ...
            <br /> we support you quickly, competently and proficiently
          </h3>
          <p>
            You could be the victim of a cyber attack at any time. Our Incident
            Response Retainer is the perfect
            <br /> solution when it comes to acting in a prepared, fast,
          ...
          <p>
            ...
            <a className="text-warning" href="/cyber-defense-center">
              *Right Time Limited
            </a>
          </p>
          <p>
