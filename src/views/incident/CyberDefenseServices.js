    ...
    <div>
      ...
      <section className="d-flex  justify-content-center">
        <div className=" p-5 container ">
          ...
          <p className="mt-3">
            Effective defence measures combined with Incident Detection and
            Response services are increasingly important to protect companies
            against cyber attacks. At our ISO 27001 certified and ISAE 3000 Type
            2 audited Cyber Defence Center in Switzerland (Baar), we combine
            first-class expertise and sophisticated technologies with the many
            years of experience of our security experts and threat analysts and
            threat analysts. Our comprehensive Cyber Defence Services protect
            your on-premise, cloud, IoT and OT infrastructures around the
            clock.{" "}
          </p>
        </div>
      </section>
            ...
            <div className="expanedItem ">
              <div className=" expaneditems1">
                <Accordion className="shadaow">
                  <Accordion.Item className="my-3" eventKey="1">
                    ...
                    <Accordion.Body>
                      ...
                      Holder Data (CHD) 2) Sensitive Authentication Data (SAD).
                      CHD covers the Data elements like Primary Account Number
                      (PAN), Cardholder Name, Service Code and Expiration Date.
                      CHD is useful to identify the Card holder, where in SAD
                      Covers data elements like Track Data, CVV, CVC, CAV, CID,
                      PIN / PIN Block. SAD is used for authorizing the card
                      holder to do the transactions.
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
                <Accordion>
                ...
                <Accordion>
                  <Accordion.Item className="my-3" eventKey="1">
                    ...
                    <Accordion.Body>
                      The latest is PCI DSS version 3.2.1 that replaces version
                      3.2. Though no new requirements were added in PCI DSS
                      3.2.1, the update was designed to eliminate any confusion
              ...
              <div className="expaneditems1 ">
                <Accordion>
                  <Accordion.Item className="my-3" eventKey="1">
                    <Accordion.Header>
                      If I Am Using A Third-Party To Process Payments{" "}
                    </Accordion.Header>
                    <Accordion.Body>
                      Yes, even if some of the payment processes may reduce your
                      risk of breach or what is in scope for PCI compliance,
                      business cannot ignore it.
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
                <Accordion>
                  <Accordion.Item className="my-3" eventKey="1">
                    <Accordion.Header>
                      If I Only Accept Credit Cards Over The Phone ?
                    </Accordion.Header>
                    <Accordion.Body>
          ...
          <Row>
            <Col md={6}>
              <div className="">
                ...
                <p className="mt-3">
                  In our InfoGuard Cyber Defence Center (CDC) in Switzerland,
                  experienced security experts work in different, highly
                  specialised teams. Collaboration within the CDC and also with
                  other InfoGuard teams creates synergies that offer our
                  customers real added value. No matter whether vulnerabilities
                  in individual components, new attack strategies or rapid
                  support in the event of an incident: we are the right partner.
                  Tailored to individual needs, companies can use our modular
                  services as managed services of their internal systems or as
                  cloud services without investing in their own infrastructure.
                  For particularly exposed data and systems, our Cyber Defence
                  Center offers you a maximum level of security. InfoGuard is
                  also a member of FIRST (Global Forum of Incident Response and
                  Security Teams), which attests to the high quality standard of
                  its cyber defence and response services.
                </p>
              </div>
            </Col>
