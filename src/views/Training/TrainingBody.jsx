...
const TRAINING_PROGRAMS = [
  {
    ...
    image:
      "https://www.ict.eu/sites/corporate/files/images/iStock-1322517295%20copy_12.jpg",
    description:
      "Right Time Limited offers training programs designed to enhance participants' knowledge and skills in conducting ICT assessments.",
    link: "/assesment",
  },
  {
    title: "Training (ICT Management)",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxon_WBBZiXpR46nVYY7QYeNg7I_J82c1xUg&s",
    description:
      "Right Time Limited provides training programs that focus on ICT management principles and practices.",
    link: "/management",
  },
  {
    title: "Training (RightTime Customized)",
    image:
      "https://img.freepik.com/free-vector/cyber-security-concept_53876-90451.jpg",
    description:
      "Right Time Limited offers customized training solutions tailored to the specific needs of organizations",
    link: "/Customized",
  },
];
...
function TrainingBody() {
      ...
      case "education":
        return (
          <p className="coming-soon">
            Education and Training Providers coming soon...
          </p>
        );
      default:
        return null;
  ...
  const handleSubmit = useCallback(
    (e) => {
      ...
      if (budget) {
        toast.success(
          "Thank you for contacting us! Our team will review your inquiry promptly.",
        );
        setBudget("");
      } else {
    ...
    <div>
      ...
      <div className="mx-5 mt-5">
        <p className="text-dark container textJustify">
          “Right Time Limited” training programs encompass ICT Assessment, ICT
          Management, and customized training solutions. By participating in
          these programs, individuals and organizations can acquire the
          necessary knowledge and skills to effectively assess and manage ICT
          systems, as well as receive tailored training to meet their specific
          requirements.{" "}
        </p>
              ...
              {TRAINING_PROGRAMS.map((program, index) => (
                ...
                >
                  ...
                  <p
                    ...
                    className="text-dark textJustify"
                  >
                    {program.description}
                  </p>
        ...
        <h1 style={{ color: "#37474f" }} className="text-center my-5">
          ICT Professional(s) will be benefited with our Track choosing
          mind-map.
        </h1>
                ...
                <div key={index} className="item">
                  <div style={{ background: "#e9e3e0" }} className="card">
                    ...
                    <div className="service-card-three__content">
                      <h4 className="pt-3">
                        <Link to="/consultation">{trainer.name}</Link>
                      </h4>
          ...
          <div className="mx-5 border px-5 mt-5">
            <div className="row">
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="mt-1 my-5 thm-btn cta-two__btn rounded-5 w-25 text-center"
                >
