          ...
          <div className="row">
            <div className="col-lg-7">
              ...
              <div className="governance-raci-diagram dipt-container">
                ...
                <div className="governance-outer-circle governance-outer-circle-1 governance-mini-circles">
                  Responsible
                </div>
                <div className="governance-outer-circle governance-outer-circle-2 governance-mini-circles">
                  Accountable
                </div>
                <div className="governance-outer-circle governance-outer-circle-3 governance-mini-circles">
                  Consulted
                </div>
                <div className="governance-outer-circle governance-outer-circle-4 governance-mini-circles">
                  Informed
                </div>
                <div className="governance-outer-circle governance-outer-circle-5 governance-mini-circles">
                  Responsible
                </div>
              </div>
            </div>
