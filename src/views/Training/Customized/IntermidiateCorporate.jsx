    ...
    <section className="section-padding--bottom section-padding--top">
        <div className="container">
          ...
          <div className="col-lg-8">
                ...
                <h3 style={{color:"orange"}} className="blog-card-one__title blog-details__title">Customozed</h3>
