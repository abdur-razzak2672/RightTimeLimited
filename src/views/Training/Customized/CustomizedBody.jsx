          ...
          <div className="row">
            <div className="col-lg-7">
              ...
              <div className="blog-details__content">
                <p>
                  “Right Time Limited” (RightTime) offers customized training
                  solutions tailored to the specific needs of organizations.
                  These programs are designed in collaboration with clients to
                  address their unique requirements, challenges, and goals. The
                  customized training covers a wide range of ICT topics,
                  including cybersecurity, data privacy, cloud computing,
                  network management, and more. By delivering training that
                  aligns with the organization's specific context, RightTime
                  helps to enhance knowledge, skills, and competencies within
                  the organization. <br />
                </p>
                <img
                  className="training-images"
                  src="/assets/images/training/Customize.jpg"
                  alt="Customize"
                />
              </div>
            </div>
