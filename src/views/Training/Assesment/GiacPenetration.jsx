            ...
            <div className="col-lg-7">
              ...
              <div className="blog-details__content">
                <p>
                  ...
                  offered by Right Time Limited for the "GIAC Penetration
                  Testing (GPEN)" certification by SANS:
                </p>
                <img loading="lazy" decoding="async"
                  className="training-images"
                  src="/assets/images/training/gpen.jpg"
                  alt="GPEN"
                />
              </div>
            </div>
              ...
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    ...
                    GIAC Penetration Testing (GPEN) certification offered by
                    SANS Institute. This course equips participants with the
                    knowledge and skills required to conduct effective
                    penetration testing and vulnerability assessments in diverse
                    environments. Through a blend of theoretical instruction and
                    hands-on practical labs, participants will learn advanced
                    penetration testing techniques, methodologies, and best
                    practices to identify and mitigate security vulnerabilities
                    effectively.{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    ...
                    <br />
                     Practical hands-on labs and simulations to simulate
                    real-world penetration testing scenarios and develop
                    practical skills.
                    <br />
                     Instruction from experienced cybersecurity professionals
                    and penetration testing experts with extensive industry
                    experience.
                    <br />
                     Exploration of advanced penetration testing tools and
                    technologies, including network, web application, and
                    wireless penetration testing tools.
                    <br />
                     Discussion of reconnaissance, enumeration, exploitation,
                    post-exploitation, and reporting phases of penetration
                    testing engagements.
                    <br />
                     Access to comprehensive study materials, practice exams,
                    and supplementary resources to support exam preparation.
                    <br />
                     Interactive discussions and knowledge-sharing sessions to
                    enhance understanding and collaboration among participants.
                    <br />
                  </p>
                </div>
              </div>
          ...
          {tabIndex === 3 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <hr />
                <p>
                   The GPEN preparatory training course by Right Time Limited
          ...
          {tabIndex === 4 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <p>
                   The cost of the GPEN preparatory training course may vary
          ...
          {tabIndex === 5 && (
            <div>
              <p>
                ...
                topics such as network reconnaissance, vulnerability assessment,
                exploitation techniques, and post-exploitation methodologies.
                <br />
                ...
                penetration testing tools and techniques used to identify and
                exploit security vulnerabilities in network systems.
                <br />
                Case Studies: Analysis of real-world penetration testing
                engagements and scenarios to enhance understanding of best
                practices, methodologies, and techniques used in ethical hacking
          ...
          {tabIndex === 6 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    The GIAC Certified Penetration Tester (GPEN) certification
                    exam is administered by SANS and assesses participants'
                    knowledge and skills in penetration testing and ethical
                    hacking. Key examination information includes:
                    <br />
                    Format: The GPEN exam is a proctored, open-book exam
                    consisting of 115 multiple-choice questions and practical
                    exercises that simulate real-world penetration testing
                    scenarios. Duration: The exam duration is typically 03
                    (three) hours, during which participants are required to
                    answer a series of questions and perform penetration testing
                    ...
                    practical exercises. A passing score 74% or higher is
                    required to obtain the GPEN certification.
                    <br />
                    Exam Delivery: The GPEN exam may be taken at authorized
                    ...
                    GPEN exam by completing Right Time Limited's comprehensive
                    ...
                    with penetration testing tools, and review of relevant
                    industry standards and methodologies.
                    <br />
                    Successfully passing the GPEN exam demonstrates
                    participants' proficiency in conducting penetration tests,
                    identifying security vulnerabilities, and recommending
                    remediation measures to improve the security posture of
          ...
          {tabIndex === 7 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                     Interested individuals can register for the GPEN
              ...
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    ...
                    <br /> Seek guidance and support from instructors or peers
                    as needed to clarify concepts and prepare effectively for
                    the GPEN certification exam.
                  </p>
                </div>
              </div>
              <div className="col-lg-4 mt-5">
          ...
          {tabIndex === 9 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                     Upon successfully obtaining the GPEN certification,
                    certified professionals should pursue continuous learning
                    and professional development to stay updated on emerging
                    trends and advancements in penetration testing and
                    vulnerability assessment.
                    <br />
                     Right Time Limited offers advanced training courses,
                    workshops, and seminars to help certified professionals
                    enhance their skills and expand their knowledge in
                    penetration testing and cybersecurity.
                    <br />
                     Certified professionals are encouraged to maintain active
                    membership with GIAC and adhere to the organization's
