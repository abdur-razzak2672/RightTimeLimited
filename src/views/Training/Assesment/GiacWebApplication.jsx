    ...
    <div>
      <div className="page-header">
        ...
        <div className="container">
          ...
          <h2 className="page-header__title"> GIAC Web Application Penetration Tester(GWAPT)</h2>
        </div>
      </div>
          ...
          <div className="row">
            <div className="col-lg-7">
              ...
              <div className="blog-details__content">
                ...
                <img className='training-images' src="/assets/images/training/GWAPT.jpeg" alt="GWAPT" />
              </div>
        ...
        <div className="container">
                ...
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      ...
                      The GWAPT preparatory training course by Right Time Limited is designed to equip security professionals with the knowledge and skills required to pass the GIAC Web Application Penetration Tester (GWAPT) certification exam. The course focuses on advanced techniques for assessing and securing web applications, including identifying vulnerabilities, performing penetration tests, and implementing effective security controls. Participants will gain hands-on experience with web application security tools, methodologies, and best practices through practical labs and real-world scenarios.                    </p>
                  </div>
            ...
            tabIndex === 3 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p>
                    	The GWAPT preparatory training course schedule may vary based on participant preferences and availability.
                    	Right Time Limited offers flexible scheduling options, including weekday, weekend, and evening sessions, to accommodate diverse schedules.
            ...
            tabIndex === 4 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p>
                    	The cost of the GWAPT preparatory training course may vary depending on factors such as the training format, duration, and additional resources included.
                    	Right Time Limited strives to offer competitive pricing and may provide special promotions, discounts, or group booking rates for participants.
...

          {
            tabIndex === 5 && (
              <div>
                <p>
                  Interactive Lectures: Participants will engage in dynamic lectures delivered by experienced cybersecurity professionals and certified instructors. The lectures cover a wide range of topics, including web application security principles, common vulnerabilities, and advanced exploitation techniques.

                  Hands-on Labs: Practical lab exercises and simulations allow participants to apply theoretical knowledge in real-world scenarios. Through hands-on experience, participants will learn how to identify, exploit, and remediate vulnerabilities in web applications using industry-standard tools and techniques.

                  Case Studies: Analysis of real-world web application security incidents and case studies provides valuable insights into best practices, methodologies, and approaches used in web application penetration testing. Participants will learn from real-world examples and gain practical experience in assessing and securing web applications.

                  Group Discussions: Interactive group discussions foster knowledge sharing, collaboration, and peer learning among participants. Through group activities, participants can exchange ideas, experiences, and best practices, enhancing their understanding of web application security concepts.
            ...
            tabIndex === 6 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      The GIAC Web Application Penetration Testing (GWAPT) certification exam is a proctored, open-book exam administered by SANS. The exam evaluates participants' knowledge and skills in web application security testing and penetration testing techniques. Key examination information includes:

                      Format: The GWAPT exam consists of 75 multiple-choice questions and practical exercises that simulate real-world web application penetration testing scenarios. Participants must demonstrate their ability to identify vulnerabilities, exploit security weaknesses, and provide recommendations for remediation.

                      Duration: The exam duration is typically 03 (three) hours, during which participants are required to answer a series of questions and perform practical tasks related to web application security testing.

                      Scoring: Participants are evaluated based on their performance in answering exam questions and completing practical exercises. A passing score 68%~71%, is required to obtain the GWAPT certification.

                      Exam Delivery: The GWAPT exam can be taken at authorized testing centers worldwide or online through remote proctoring, offering flexibility and convenience for participants.

                      Preparation: Participants are advised to prepare for the GWAPT exam by completing Right Time Limited's comprehensive training program, reviewing course materials, and practicing with sample questions and practical exercises. Additionally, self-study, hands-on practice with web application security tools, and review of relevant industry standards and guidelines are recommended to enhance preparedness for the exam.

                      Successfully passing the GWAPT exam demonstrates participants' proficiency in assessing and securing web applications, validating their expertise in web application penetration testing and enhancing their credibility as cybersecurity professionals.
            ...
            tabIndex === 8 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      	Actively participate in training sessions, labs, and exercises to develop practical skills and proficiency in web application penetration testing techniques.
                      	Utilize study materials provided by Right Time Limited, including practice exams, reference guides, and hands-on labs, to reinforce learning and review key concepts.
                      	Dedicate time for self-study and practice outside of scheduled sessions to deepen understanding and mastery of web application security assessment concepts and methodologies.
            ...
            tabIndex === 9 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      	After obtaining the GWAPT certification, certified professionals should engage in continuous learning and professional development to stay updated on evolving web application security trends and technologies.
                      	Right Time Limited offers advanced training courses, workshops, and seminars to help certified professionals enhance their skills and expand their knowledge in web application penetration testing.
                      	Certified professionals are encouraged to maintain active membership with GIAC and fulfill the organization's Continuing Professional Education (CPE) requirements to retain their certification status.
