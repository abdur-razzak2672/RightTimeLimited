        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-7">
              ...
              <h3 className="blog-card-one__title blog-details__title changeColor">Certified Information system Auditor (CISA)</h3>
              <div className="blog-details__content">
                ...
                <img className='training-images' src="/assets/images/training/cisa.webp" alt="cisa" />
              </div>
