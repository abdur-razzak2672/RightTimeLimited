          ...
          <div className="row">
            <div className="col-lg-7">
              ...
              <div className="blog-details__content">
                <p>
                  The GIAC Certified Project Manager (GCPM) certification
                  validates a practitioner's knowledge of technical project
                  management methodology and implementation. GCPM certification
                  holders have demonstrated the critical skill sets associated
                  with making projects successful, including effective
                  communication and time, cost, quality, procurement, and risk
                  management of IT projects and application development.{" "}
                </p>
                <img loading="lazy" decoding="async"
                  className="training-images"
                  src="/assets/images/training/GCPM.webp"
                  alt=""
                />
              </div>
            </div>
      ...
      <section className="mt-1">
        <div className="container">
          {tabIndex === 1 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    Right Time Limited offers preparatory training for the GIAC
                    Certified Project Manager (GCPM) certification, designed to
                    equip professionals with the skills and knowledge necessary
                    to effectively manage and execute cybersecurity projects.
                    The course covers key project management principles,
                    methodologies, and best practices tailored to the
          ...
          {tabIndex === 2 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                     In-depth coverage of project management concepts specific
                    to cybersecurity
                    <br />
                     Expert-led instruction by experienced project managers
                    <br />
          ...
          {tabIndex === 5 && (
            <div>
              <p>
                Interactive Lecture: Engage with expert instructors who cover
                key project management principles and cybersecurity concepts.
                <br />
                Hands-on Lab: Apply learned concepts through practical exercises
                and simulations.
                <br />
                Case Studies: Analyze real-world scenarios to understand project
                management challenges in cybersecurity.
                <br />
                Group Discussion: Collaborate with peers to share insights and
                perspectives on project management techniques.
                <br />
                Mock Examination: Assess your readiness for the GCPM exam with
                practice tests designed to simulate the actual exam environment.
                <br />
              </p>
            </div>
          )}
              ...
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    ...
                    <br />
                    Number of Questions: Around 150
                    <br />
                    Scoring: Each question is worth a certain number of points,
                    with the total score determining pass/fail status.
                    <br />
                    Passing Score: The passing score varies and is determined by
                    GIAC.
                    <br />
                    Exam Delivery: The GCPM exam is proctored by GIAC and can be
                    taken online or at a designated testing center.
                    <br />
                    Preparation:
                    <br />
                    <br />
                     Attend all training sessions and actively participate to
                    gain a comprehensive understanding of project management in
                    cybersecurity.
                    <br />
                     Utilize hands-on labs, case studies, and group discussions
                    to apply theoretical knowledge to practical situations.
                    <br />
                     Take advantage of mock examinations to familiarize
                    yourself with the exam format and assess your readiness.
                    <br />
                     Review study materials provided by Right Time Limited and
                    supplement with additional resources as needed.
                    <br />
                    <br />
                    Retake Policy: If you do not pass the GCPM exam on your
                    first attempt, you may retake it after a waiting period
                    determined by GIAC. Right Time Limited can provide guidance
                    and support for exam retakes, including additional study
                    resources and preparation assistance to improve your chances
                    of success.
                  </p>
                </div>
              </div>
          ...
          {tabIndex === 7 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    To register for the Disaster Recovery Professional training
                    course, please fill out the registration form on our website
                    i.e. https://www.righttime.biz/, or contact our training
          ...
          {tabIndex === 8 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                     Attend all training sessions and actively participate
                    <br />
                     Review course materials and resources provided by Right
                    Time Limited
                    <br />
                     Practice with sample questions and mock exams
                    <br />
                     Engage in group discussions and case study analysis
                    <br />
          ...
          {tabIndex === 9 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    GIAC certifications require periodic renewal through
                    Continuing Professional Education (CPE) credits. Right Time
                    Limited can provide guidance on fulfilling CPE requirements
                    and staying current with evolving project management
                    practices in the cybersecurity field.{" "}
                  </p>
                </div>
              </div>
              <div className="col-lg-4 mt-5">
