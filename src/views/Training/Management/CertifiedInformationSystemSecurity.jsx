            ...
            <div className="col-lg-7">
              ...
              <div className="blog-details__content">
                <p>
                  ...
                  (CISSP) training offered by Right Time Limited prepares
                  individuals for one of the most globally recognized
                  certifications in the field of cybersecurity. The course
                  covers essential topics such as security and risk management,
                ...
                <img loading="lazy" decoding="async"
                  ...
                  src="/assets/images/training/CISSP.webp"
                  alt=""
                />
              </div>
            </div>
      ...
      <section className="mt-1">
        <div className="container">
              ...
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    ...
                    individuals for one of the most globally recognized
                    certifications in the field of cybersecurity. The course
                    covers essential topics such as security and risk
                    management, asset security, security architecture and
                    engineering, communication and network security, identity
          ...
          {tabIndex === 2 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                     Expert-led training by certified instructors
                    <br />
                     Comprehensive coverage of CISSP domains
                    <br />
          ...
          {tabIndex === 5 && (
            <div>
              <p>
                The CISSP training provided by Right Time Limited offers a
                comprehensive approach, including interactive lectures delivered
                by experienced instructors, hands-on lab sessions to reinforce
                concepts, real-world case studies for practical application,
                engaging group discussions to share insights, and mock
                examinations to simulate the actual test environment.
              </p>
            </div>
          )}
          ...
          {tabIndex === 6 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    Format: The CISSP exam by (ISC)² is typically a
                    computer-based test with multiple-choice and advanced
                    innovative questions.
                    <br />
                    Duration: Candidates are given up to 3 hours to complete the
                    exam.
                    <br />
                    Number of Questions: The exam consists of 100-150 questions,
                    covering various domains of cybersecurity.
                    <br />
                    Scoring: Each question carries a specific weight, and the
                    total score is calculated based on the number of correct
                    answers.
                    <br />
                    Passing Score: A passing score of 700 out of 1000 points is
                    required to earn the CISSP certification.
                    <br />
                    Exam Delivery: The exam can be taken at Pearson VUE testing
                    centers worldwide or through online proctoring.
                    <br />
                    Preparation: Preparation involves studying the CISSP Common
                    Body of Knowledge (CBK), attending training sessions,
                    practicing with sample questions, and reviewing relevant
                    resources provided by Right Time Limited.
                    <br />
                    Retake Policy: If a candidate does not pass the CISSP exam
                    on the first attempt, (ISC)² allows for retakes under
                    certain conditions. There is a waiting period of 30 days
                    between exam retakes, and candidates can attempt the exam up
                    to three times within a 12-month period. Additional fees
                    apply for each retake. Right Time Limited can provide
                    further details about (ISC)²'s retake policy and offer
                    guidance on preparing for exam retakes to improve the
              ...
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    ...
                    <br />
                     Study the CISSP Common Body of Knowledge (CBK)
                    <br />
                     Practice with sample questions and mock exams
                    <br />
                     Engage in group discussions and hands-on labs
                    <br />
                     Review relevant study materials provided by Right Time
                    Limited
                    <br />
                  </p>
                </div>
          ...
          {tabIndex === 9 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    CISSP certification holders are required to earn Continuing
                    Professional Education (CPE) credits annually to maintain
                    their certification. Right Time Limited can provide guidance
                    on fulfilling CPE requirements and staying up-to-date with
