        ...
        <div className="container">
                ...
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      ...
                      The Cyber Security Analyst course offered by Right Time Limited equips participants with the knowledge and skills required to detect, analyze, and respond to cybersecurity threats effectively. Covering a range of topics such as threat intelligence, incident response, and vulnerability assessment, this course prepares individuals for the role of a cybersecurity analyst in today's dynamic threat landscape.
                    </p>                  </div>
            ...
            tabIndex === 2 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      	Comprehensive curriculum aligned with industry best practices.<br />
                      	Experienced instructors with expertise in cybersecurity.<br />
                      	Hands-on labs and real-world case studies for practical learning.<br />
                      	Preparation for the Cyber Security Analyst certification exam.<br />
                      	Access to resources and study materials for continued learning.<br />
            ...
            tabIndex === 3 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p>
                    The course is available in both in-person and online formats, with flexible scheduling options to accommodate diverse learner needs. Please contact Right Time Limited for the latest schedule information.
                  </p>
              ...
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <p>
                    ...
                    Pricing for the Cyber Security Analyst training course varies based on the delivery format and any additional services or materials included. For detailed pricing information and special offers, please reach out to Right Time Limited.
                  </p><br />
...

          {
            tabIndex === 5 && (
              <div>
                <p>
                  The Cyber Security Analyst training by Right Time Limited employs an interactive approach, combining:<br />

                  Interactive Lectures: Engaging sessions led by experienced instructors covering key concepts and methodologies.<br />

                  Hands-on Lab: Practical exercises to reinforce learning and develop technical skills in a simulated environment.<br />

                  Case Studies: Real-world scenarios to analyze and apply cybersecurity principles.<br />

                  Group Discussion: Collaborative sessions to exchange ideas, share experiences, and explore best practices.<br />

                  Mock Examination: Practice tests to assess readiness for the certification exam.<br />
            ...
            tabIndex === 6 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      Format: Online exam administered by EC-Council.<br />

                      Duration: The duration of the exam is typically 04 (four) hours.<br />

                      Number of Questions: The exam consists of 125 multiple-choice questions.<br />

                      Scoring: Each question carries a certain weightage, and the total score determines the candidate's performance.<br />

                      Passing Score: To pass the exam, candidates must achieve a minimum score of 70%.<br />

                      Exam Delivery: The exam is delivered through EC-Council's online platform, allowing candidates to take it remotely from anywhere with internet access.<br />

                      Preparation: Prepare for the exam by thoroughly reviewing course materials, participating actively in training sessions, completing hands-on exercises, and taking practice exams.
                      <br />
                      Retake Policy: In case a candidate does not pass the certification exam on the first attempt, EC-Council's retake policy allows for additional attempts subject to certain conditions and fees. Candidates are advised to refer to EC-Council's official retake policy for detailed information and procedures. Additionally, Right Time Limited can provide guidance and support regarding retake options and exam preparation strategies.
            ...
            tabIndex === 7 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      To register for the Cyber Security Analyst course, interested individuals can visit Right Time Limited's website i.e. https://www.righttime.biz/, or contact their enrollment team directly. Registration may require filling out a registration form and providing necessary details.                    </p>
                  </div>
                ...
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      ...
                      Prepare for the course by familiarizing yourself with basic cybersecurity concepts and terminology. Stay updated with the latest trends and developments in cybersecurity through relevant publications, forums, and online resources. Review any pre-course materials provided by Right Time Limited and actively participate in training sessions.
            ...
            tabIndex === 9 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      After obtaining the Cyber Security Analyst certification, individuals must adhere to EC-Council's certification maintenance requirements to keep their credentials active. This may include earning continuing education credits or renewing the certification periodically. Right Time Limited can provide guidance on maintaining certification status and accessing relevant resources for ongoing professional development.                    </p>
                  </div>
