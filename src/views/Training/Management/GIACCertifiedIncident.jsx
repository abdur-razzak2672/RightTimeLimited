  ...
  return (
    ...
    <div className="page-header">
      ...
      <div className="container">
        ...
        <h2 className="page-header__title">GIAC Certified Incident</h2>
      </div>
    </div>
    <section className="section-padding--bottom section-padding--top">
        <div className="container">
          ...
          <div className="col-lg-8">
                ...
                <h3 style={{color:"orange"}} className="blog-card-one__title blog-details__title">GIACCertifiedIncident</h3>
