    ...
    <div>
      <div className="page-header">
        ...
        <div className="container">
          ...
          <h2 className="page-header__title">Disaster Recovery Professional (Custom)</h2>
        </div>
      </div>
        ...
        <div className="container">
            ...
            tabIndex === 2 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      	Comprehensive coverage of disaster recovery concepts and best practices.<br />
                      	Hands-on exercises and case studies to apply theoretical knowledge to real-world scenarios.<br />
                      	Expert-led sessions by experienced instructors in the field of disaster recovery.<br />
                      	Practical insights into implementing and managing disaster recovery plans within organizations.<br />
                      	Preparation for the EC-Council Disaster Recovery Professional certification exam.<br />
...

          {
            tabIndex === 5 && (
              <div>
                <p>
                  Our Disaster Recovery Professional training course offers a dynamic learning experience through:<br />

                  Interactive Lectures: Engaging sessions led by experienced instructors to cover key concepts and principles.<br />

                  Hands-on Labs: Practical exercises to apply theoretical knowledge and develop critical skills.<br />

                  Case Studies: Real-world scenarios to analyze and solve challenges related to disaster recovery.<br />
                  Group Discussions: Collaborative learning environment for sharing insights and experiences.<br />

                  Mock Examination: Practice exams to assess readiness for the certification exam.<br />
            ...
            tabIndex === 6 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      Format: The EC-Council Disaster Recovery Professional certification exam is conducted online and consists of multiple-choice questions.<br />

                      Duration: The exam duration is typically 04 (four) hours.

                      Number of Questions: The exam comprises a set number of questions i.e. 150 assessing various aspects of disaster recovery.<br />

                      Scoring: Each question carries a specific weightage, and scores are calculated based on the correct answers provided.<br />
                      Passing Score: To pass the exam and obtain certification, candidates must achieve the minimum passing score 70% determined by EC-Council.<br />

                      Exam Delivery: The exam is delivered through EC-Council's online platform, accessible from any location with an internet connection.<br />

                      Preparation: Adequate preparation involves thorough review of course materials, participation in training sessions, and practice with mock examinations.<br />

                      Retake Policy: In the event that a candidate does not pass the certification exam on the first attempt, EC-Council's retake policy allows for additional attempts after a specified waiting period. Candidates must adhere to EC-Council's retake policy guidelines, including any associated fees and waiting periods between exam attempts. For detailed information on retake policies, candidates are advised to refer to EC-Council's official guidelines or contact our training coordinator for assistance.<br />
            ...
            tabIndex === 8 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      	Review course materials provided by Right Time Limited and EC-Council.<br />
                      	Engage actively during training sessions and participate in hands-on exercises.<br />
                      	Take advantage of additional study resources and practice exams available through EC-Council.<br />
                      	Collaborate with peers and instructors to clarify doubts and deepen understanding.<br />
            ...
            tabIndex === 9 && (
              <div className="row">
                <div className="col-lg-8">
                  ...
                  <div className="blog-details__content">
                    <p>
                      After obtaining the Disaster Recovery Professional certification, professionals are required to fulfill EC-Council's certification maintenance requirements, which may include continuing education and periodic recertification exams. Stay updated with EC-Council's certification policies and guidelines to maintain your certification status.
                    </p>
                  </div>
