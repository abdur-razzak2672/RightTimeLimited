          ...
          <div className="row">
            <div className="col-lg-7">
              ...
              <div className="blog-details__content">
                <p>
                  The Certified Information Security Manager (CISM) course is
                  designed for professionals who are responsible for managing,
                  designing, and overseeing an enterprise's information security
                  program. The course covers essential concepts related to
                  information risk management, information security governance,
                  incident response, and cybersecurity strategies. CISM
                  certification is globally recognized and demonstrates a
                  candidate's expertise in information security management and
                  governance.
                </p>
                <img loading="lazy" decoding="async"
                  className="training-images"
                  src="/assets/images/training/CISM.png"
                  alt=""
                />
              </div>
            </div>
          ...
          {tabIndex === 1 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    The CISM certification is globally recognized for
                    professionals who manage, design, oversee, and assess an
                    enterprise's information security. This course provides
                    comprehensive training to equip participants with the
                    knowledge and skills required to pass the CISM exam and
                    excel in information security management roles.
                  </p>{" "}
                </div>
              </div>
          ...
          {tabIndex === 2 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                     In-depth coverage of the four domains of the CISM exam:
                    Information Security Governance, Risk Management,
                    Information Security Program Development and Management,
                    Information Security Incident Management
                    <br />
                     Hands-on experience with industry-leading security
                    management practices and frameworks
                    <br />
                     Practical case studies and real-world scenarios
                    <br />
                     Expert guidance from experienced instructors who are
                    CISM-certified themselves
                    <br />
                     Access to additional study materials and resources
                    <br />
                  </p>
                </div>
              </div>
          ...
          {tabIndex === 5 && (
            <div>
              <p>
                ...
                instructors covering key concepts and domains of the CISM exam.
                <br />
                Hands-on Lab: Practical exercises to apply theoretical knowledge
                in real-world scenarios and enhance understanding.
                <br />
                Case Studies: Analyzing real-life case studies to gain insights
                into information security management practices.
                <br />
                Group Discussion: Collaborative sessions to exchange ideas,
                share experiences, and address common challenges.
                <br />
                Mock Examination: Practice tests designed to simulate the CISM
                exam environment and assess readiness.
                <br />
              </p>
            </div>
          )}
          ...
          {tabIndex === 6 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    Format: Multiple-choice questions (MCQs) and scenario-based
                    questions.
                    <br />
                    Duration: 4 hours.
                    <br />
                    Number of Questions: Approximately 150 questions.
                    <br />
                    ...
                    <br />
                    Exam Delivery: Computer-based testing (CBT) at designated
                    testing centers worldwide.
                    <br />
                    Preparation: Comprehensive review of the CISM exam content
                    outline, utilization of official ISACA study materials, and
                    participation in practice exams and study groups.
                    <br />
                    Retake Policy:
                    <br />
                    <br />
                     Candidates who do not pass the CISM exam on their first
                    attempt may retake the exam during subsequent testing
                    windows.
                    <br />
                     There is no limit on the number of retakes allowed;
                    however, candidates must wait at least 30 days between exam
                    attempts.
                    <br />
                     Retake candidates are required to pay the exam fee for
                    each attempt.
                    <br />
                     It is recommended that candidates utilize the interim
                    period between attempts to address weak areas, further
                    study, and enhance preparation.
                    <br />
                     Join Right Time Limited for comprehensive training on the
                    CISM certification, designed to equip you with the knowledge
                    and skills necessary to excel in information security
                    management roles and successfully pass the CISM exam.
                    <br />
                  </p>
                </div>
              </div>
          ...
          {tabIndex === 7 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    To register for the course, visit our website i.e.
                    https://www.righttime.biz/, or contact our registration team
                    via phone or email. Limited seats are available, so early
          ...
          {tabIndex === 8 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                     Review the CISM exam content outline provided by ISACA to
                    understand the domains and topics covered in the exam.
                    <br />
                     Utilize official ISACA study materials and resources,
                    including practice questions and mock exams.
                    <br />
                     Participate in review sessions, study groups, and online
                    forums to discuss key concepts and clarify doubts.
                    <br />
                     Stay updated on the latest industry trends, best
                    practices, and regulatory requirements related to
          ...
          {tabIndex === 9 && (
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="blog-details__content">
                  <p>
                    After obtaining the CISM certification, professionals must
                    adhere to ISACA's Continuing Professional Education (CPE)
                    policy to maintain their certification. This involves
                    earning and reporting a minimum number of CPE credits
                    annually through activities such as attending relevant
                    training courses, conferences, webinars, and contributing to
                    industry publications or research. Join us to advance your
                    career in information security management and become a
                    certified CISM professional with the support and guidance of
                    Right Time Limited.
                  </p>
                </div>
              </div>
