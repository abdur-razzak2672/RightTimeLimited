        ...
        <div>
            <div className="page-header">
                <div className="page-header__bg"
                    style={{ backgroundImage: `url('http://www.stemmonsservices.com/wp-content/uploads/2018/02/5064042-hd-business-wallpaper.jpg')` }}>
            ...
            <section
                ...
                <div className="container">
                    ...
                    <div className="owl-carousel client-carousel--two">
                        <div className="container">
                            <div className="owl-carousel thm-owl__carousel" data-owl-options='{"loop": true,
				"autoplay": true,
				...
				"responsive": {
					...
					"1200": {
						...
						"items": 5
                                ...
                                <div className="item">
                                    <img src="/assets/images/resources/bangladesh bank.png" alt="" />
                                </div>
                                <div className="item">
                                ...
                                <div className="item">
                                    <img src="/assets/images/resources/Transparency International Bangladesh.png" alt="" />
                                </div>
                                <div className="item">
                                    <img src="/assets/images/resources/paywell.png" alt="" />
                                </div>
                                <div className="item">
                                    <img src="/assets/images/resources/Shahajalal Islami Bank_Logo.png" alt="" />
                                </div>
                                <div className="item">
                                ...
                                <div className="item">
                                    <img src="/assets/images/resources/meghnagbanklogo.png" alt="" />
                                </div>
                                <div className="item">
                                    <img src="/assets/images/resources/walletmix.png" alt="" />
                                </div>
                                <div className="item">
                                    <img src="/assets/images/resources/circle-fintech.png" alt="" />
                                </div>
                                <div className="item">
                    ...
                    <div className="row gutter-y-30">
                        <div className="col-lg-3 col-md-6 col-sm-12">
                            <div className="service-card-two gray-bg">
                                <h3 className="service-card-two__title"><a href="services-1.html">Quality Service</a></h3>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12">
                            <div className="service-card-two gray-bg">
                                <h3 className="service-card-two__title"><a href="team.html">Expert Team</a></h3>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12">
                            <div className="service-card-two gray-bg">
                                <h3 className="service-card-two__title"><a href="contact.html">Excellent Support</a></h3>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12">
                            <div className="service-card-two gray-bg">
                                <h3 className="service-card-two__title"><a href="about.html">Management</a></h3>
            ...
            <section className="cta-one" style={{ paddingBottom: "5%" }}>
                <div className="container">
                    <div className="cta-one__inner text-center wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <a href="/contact-us" className="thm-btn thm-btn--light cta-one__btn"><span>Start Now</span></a>
