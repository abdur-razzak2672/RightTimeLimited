      ...
      <div>
        <div className="page-header">
          ...
          <div className="container">
            ...
            <h2 className="page-header__title">Information System Audit</h2>
        ...
        <div className="container">
          <div className="section-title">
            ...
            <div className="row">
              ...
              <p className="mt-5">Web application security testing as per the OWASP Top 10 list, helps to identify many unattended issues related to programming, file access and configuration etc which may turn out to be vulnerabilities, causing a potential impact on the organization.
              ...
              <img className="w-100" src="/assets/images/services/info_systems_audit.png" alt="" />
