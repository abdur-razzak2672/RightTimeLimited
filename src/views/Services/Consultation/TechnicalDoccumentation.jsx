  ...
  return (
    <div>
        ...
        <div className="container">
          <Row style={{ marginLeft: "20%", marginRight: "20%" }}>
            <Col md={6}>
              <div>
                ...
                <p>
                  Save hours of followup and reporting time by easily tracking
                  employee acceptance of new policies. Generate reports and
                  export documents for easy auditing.
                </p>
              </div>
            </Col>
            ...
            <Col md={6}>
              <div>
                ...
                <p style={{ borderBottom: "1px solid red", width: "30%" }}></p>
                <p>
                  Built-in approval management workflows allow you to assign
                  approvals to the appropriate team members and keep an approval
                  history for audits.
                </p>
              </div>
            </Col>
            <Col md={6}>
              <div>
                ...
                <p style={{ borderBottom: "1px solid red", width: "30%" }}></p>
                <p>
                  Enhanced in-app document editing adds powerful editing
                  capabilities and streamlines the user experience. Save time
                  and edit documents in-app.
                </p>
              </div>
            </Col>
            ...
            <Col md={6}>
              <div>
                ...
                <p>
                  ...
                  Compare differences and changes for published and draft
                  policies to easily review and approve
                </p>
              </div>
            </Col>
          </Row>

          <h3 className="text-center header mb-5 mt-5">
          ...
          <Row style={{ marginLeft: "20%", marginRight: "20%" }}>
            <Col md={6}>
              <div>
                ...
                <p style={{ borderBottom: "1px solid red", width: "30%" }}></p>
                <p>
                  Policies can easily become scattered, lost, or changed without
                  approval, leading to potential liabilities. Keep all your
                  policy documents in one single place.
                </p>
              </div>
            </Col>
            ...
            <Col md={6}>
              <div>
                ...
                <p style={{ borderBottom: "1px solid red", width: "30%" }}></p>
                <p>
                  How exactly do your polices fit into your compliance and risk
                  program? Create connections between frameworks, controls,
                  risks and assets.
                </p>
              </div>
            </Col>
            <Col md={6}>
              <div>
                ...
                <p style={{ borderBottom: "1px solid red", width: "30%" }}></p>
                <p>
                  Policies reflect how your organization behaves. It's values
                  and ethics. Keep policies consistent as the organization grows
                  and changes.
                </p>
              </div>
            </Col>
            ...
            <Col md={6}>
              <div>
                ...
                <p style={{ borderBottom: "1px solid red", width: "30%" }}></p>
                <p>
                  Effective policy management leads to faster identification of
                  risk, earlier response times, and eliminates risks associated
                  with policy approvals and acceptance.
                </p>
              </div>
            </Col>
          </Row>
          ...
          <section className="section-padding--top about-one">
            <div className="section-title text-center">
              <h2 className="header">
                Some of Our Valued Customers-RightTime Extended Its Hands For
     ...
     <Col md={3} sm="6">
      ...
      <div
        className="py-5 section-padding--bottom"
        style={{ backgroundColor: "darkcyan", marginBottom: "5%" }}
      >
        <h1 className="text-center text-light">Policy Management Features</h1>
        <div className="d-flex justify-content-center">
