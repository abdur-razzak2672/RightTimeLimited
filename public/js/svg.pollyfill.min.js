...
([
    ...
    (function(module, exports, __webpack_require__) {
        ...
        window.isGetTotalLengthSupported = isGetTotalLengthSupported;
        ...
        (function(global, factory) {
            ...
            Bezier$1.prototype = {
                ...
                getPointAtLength: function(length) {
                    ...
                    return this.getPoint([this.a.x, this.b.x, this.c.x, this.d.x], [this.a.y, this.b.y, this.c.y, this.d.y],
                        t);
                },
                ...
                getPropertiesAtLength: function(length) {
                    ...
                    var point = this.getPoint([this.a.x, this.b.x, this.c.x, this.d.x], [this.a.y, this.b.y, this.c.y, this.d.y],
                        t);
                    return {
                        x: point.x,
                        y: point.y,
            ...
            function cubicDerivative(xs, ys, t) {
                var derivative = quadraticPoint(
                    [3 * (xs[1] - xs[0]), 3 * (xs[2] - xs[1]), 3 * (xs[3] - xs[2])], [3 * (ys[1] - ys[0]), 3 * (ys[2] - ys[1]), 3 * (ys[3] - ys[2])],
                    t);
                return derivative;
            }
...
//# sourceMappingURL=svg-path-polyfill.js.map