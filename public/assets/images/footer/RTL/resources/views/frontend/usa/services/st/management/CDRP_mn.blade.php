...
<div class="page-header">
    ...
    <div class="container">
        <ul class="thm-breadcrumb list-unstyled">
            ...
            <li><a href="{{ url('usa/services/security-training') }}">Training</a></li>
            <li><a href="{{ url('usa/services/security-training/management') }}">Management</a></li>
            <li>Certified Disaster Recovery Professional</li>
        </ul>
        <h2 class="page-header__title">Certified Disaster Recovery Professional</h2><!-- /.page-header__title -->
    </div><!-- /.container -->
</div><!-- /.page-header -->
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    <div class="sidebar__item sidebar__item--category">
                        @include('frontend.usa.services.st.management.cmn')
                    </div><!-- /.sidebar__item -->
                </div><!-- /.sidebar -->
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
