    ...
    <div class="page-header">
        ...
        <div class="container">
            <ul class="thm-breadcrumb list-unstyled">
                ...
                <li><a href="{{ url('aus/services/solutions') }}">Solutions</a></li>
                <li>Net Sporker</li>
            </ul>
            <h2 class="page-header__title">Net Sporker</h2><!-- /.page-header__title -->
        </div><!-- /.container -->
    </div><!-- /.page-header -->
                ...
                <div class="col-lg-4">
                    <div class="sidebar">
                        <div class="sidebar__item sidebar__item--category">
                            @include('frontend.aus.services.solutions.common')
                        </div><!-- /.sidebar__item -->
                    </div><!-- /.sidebar -->
                </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
