                ...
                <div class="col-lg-4">
                    <div class="contact-one__info wow fadeInRight" data-wow-duration="1500ms"
                        ...
                        <div class="contact-one__item">
                            ...
                            <p class="contact-one__item__text">Hausmann str-1.44139, <br>Dortmund. Germany</p><!-- /.contact-one__item__text -->
                        </div><!-- /.contact-one__item -->
                        <div class="contact-one__item">
                            <h3 class="contact-one__item__title">Phone</h3><!-- /.contact-one__item__title -->
                            <p class="contact-one__item__text">Local: <a href="#">(+49) 2311377672</a><br>
                                Mobile: <a href="tel:0008888999">(+49) 01624069887</a></p>
                        ...
                        <div class="contact-one__item">
                            ...
                            <p class="contact-one__item__text"><a
                                    href="mailto:coo.de@righttime.biz">coo.de@righttime.biz</a></p>
                            <!-- /.contact-one__item__text -->
                        </div><!-- /.contact-one__item -->
                        <div class="contact-one__item">
