    ...
    <div class="page-header">
        ...
        <div class="container">
            <ul class="thm-breadcrumb list-unstyled">
                ...
                <li><a href="{{ url('aus/services/standard-implementation-certification') }}">Standard Implementation & Certification</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <h3 class="blog-card-one__title blog-details__title">Payment Card Industry Data Security Standard (PCI DSS)
                    </h3>
                    ...
                    <h4>PCI SSC & Card Security Program:</h4>
                    <div class="blog-details__content">
                    ...
                    <div class="blog-details__content">
                        <p>The PCI Security Standards Council is an open global forum, launched in 2006 consisting of
                            ...
                            Introductory awareness sessions<br>
                            Gap Analysis<br>
                            Remediation assistance at the mitigation stages<br>
                            Compliance audits<br>
                            Mapping processes to PCI DSS requirements<br>
                            Compliance Report<br>
                            Training, policy and strategy development/definition<br>
                            Methodology<br>
                        </p>
                    </div><!-- /.blog-details__content --><br>
                ...
                <div class="col-lg-4">
                    <div class="sidebar">
                        <div class="sidebar__item sidebar__item--category">
                            @include('frontend.aus.services.sic.common')
                        </div><!-- /.sidebar__item -->
                    </div><!-- /.sidebar -->
                </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
