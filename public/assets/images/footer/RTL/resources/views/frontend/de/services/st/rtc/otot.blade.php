...
<section style="background-color: black" class="section-padding--top section-padding--bottom about-one-associate">
    ...
    <div class="wrapper">
        ...
        <div class="card tryhackme">
            <div class="content"><a class="a1" href="{{ url('de/services/security-training/right-time-customized/basic') }}">
        ...
        <div class="card tryhackme">
            <div class="content"><a class="a1" href="{{ url('de/services/security-training/right-time-customized/advanced') }}">
        ...
        <div class="card tryhackme">
            <div class="content"><a class="a1" href="{{ url('de/services/security-training/right-time-customized/intermediate') }}">
        ...
        <div class="card tryhackme">
            <div class="content"><a class="a1" href="{{ url('de/services/security-training/right-time-customized/one-to-one-training') }}">
